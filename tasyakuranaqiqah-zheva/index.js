...
const SHEET_URL = 'https://script.google.com/macros/s/AKfycbydy2wQ_o6UaEAMoi1mrDRGYqMYnF_RrzAGsN3p2m8eVbvGyT0qKb2Ah6FZN_WTTrVp/exec';
let greetingsArray = [];
...
petaBtn.addEventListener('click', () => {
  window.open('https://goo.gl/maps/nzeDuzWHajJV2B5w6', '_blank');
})
...
let x = setInterval(() => {
  ...
  let eventDate = new Date("Aug 13, 2023 13:00:00").getTime();
